...
function handleFilter(genre) {
  if(genre !== "All") {
    const filteredMovie = movies.filter((item) => item.genre === genre)
    console.log("Clicked Genres: "+genre);
    setDisplayMovie(filteredMovie);
  } else {
    console.log("Clicked Genres: All");
  ...
  return (
    <div id="main">
      ...
      <FilterMovie genres={genres} handleFilter={handleFilter}/>
      <MovieList displayMovie ={displayMovie} />
    </div>
  );
}
